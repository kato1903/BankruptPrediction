...
namespace Discretization
{
    ...
    {
        public MongoDBService Service = null;
        ...
        public MongoDBService(string connectionString, string databaseName, string collectionName)
        {
            try
            {
                ...
                //                this.InitiateService(connectionString, databaseName, collectionName);
            }
            catch (Exception e)
            {
        ...
        public void InitiateService(string connectionString, string databaseName, string collectionName)
        {
            if (Service == null)
